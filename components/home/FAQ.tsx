      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        <AccordionItem value="item-1" className="border-none bg-zinc-900/50 rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline text-white py-4">
            How does Heritaz work?
          </AccordionTrigger>
          <AccordionContent className="text-zinc-400 pb-4">
            Heritaz uses smart contracts on the Solana blockchain to create a secure, automated inheritance system. 
        ...
        <AccordionItem value="item-3" className="border-none bg-zinc-900/50 rounded-lg px-4">
          ...
          <AccordionContent className="text-zinc-400 pb-4">
            Yes, alot. Heritaz is built on Solana&apos;s blockchain, ensuring maximum security and transparency. 
        ...
        <AccordionItem value="item-4" className="border-none bg-zinc-900/50 rounded-lg px-4">
          ...
          <AccordionContent className="text-zinc-400 pb-4">
            You can verify the code and smart contract by checking the source code on <a href="https://github.com/amritwt/Heritaz" className="underline">Github</a>.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
